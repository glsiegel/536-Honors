 ...
 * 
 * @param <T> The type to store in the global environment. The Checker cares
 *            about VarType and the Interpreter cares about Object. This way, by
 *            specifying T as either VarType or Object, we can use this for
 *            multiple purposes.
 */
public class FileInfo<T> {
	 ...
	 * the file has been updated since last evaluation.
	 */
	 ...
	 */
	private List<error.IError> errors = null;
	...
	public void evaluate(List<error.IError> errors) {
		evaluate(errors, null, null, null);
	}

	public void evaluate(List<error.IError> errors, List<Stmt> stmts) {
		evaluate(errors, stmts, null, null);
	}

	public void evaluate(List<error.IError> errors, List<Stmt> stmts, GlobalEnvironment<T> env) {
	...
	public GlobalEnvironment<T> getGlobals() {
		return globals;
	}
	...
	public List<error.IError> getErrors() {
		return this.errors;
	}
	
	/**
	 * Adds to the errors of this file info
	 * 
	 * @param new_errors errors to add
	 */
	public void addToErrors(List<error.IError> new_errors) {
		if (this.errors == null) {
