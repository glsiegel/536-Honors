...
//			System.err.println("Manager is worthless, closing it.");
	...
	public void closeFile(File f) {
		...
		if (in_manager != null)
			checkWorthlessAndCleanup(in_manager);
	}

	/**
	 * When a file is changed to be a singleton, removes it from its manager.
	 * 
	 * @param f file that is newly singleton
	 */
...
//			System.err.println("Manager is worthless, closing it.");
	 ...
	 * exists, returns null.
	 * 
	 * @param rootpath pointing rootpath
	 * @param f        file of rootpath
	 * @return file manager if there is a file manager that should own this
	 *         rootpath, null otherwise
	 */
	 ...
	 * 
	 * @param rootpath pointing rootpath
	 * @return file manager if there is a file manager that owns this rootpath, null
	 *         otherwise
	 */
