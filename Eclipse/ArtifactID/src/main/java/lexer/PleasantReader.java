...
public class PleasantReader implements java.lang.AutoCloseable {
	 ...
	 * 
	 * @return int representation of the peeked value
	 * @throws IOException if reader has trouble reading from stream
	 */
	...
	/**
	 * Gets the current character offset of the reader.
	 * 
	 * @return reader char offset in the line
	 */
	public int getChar() {
		return char_num;
	}
