...
public class LocalEnvironment<T> implements IEnvironment<T> {
	...
	public LocalEnvironment(IEnvironment<T> parent) {
		...
		if (this.function) this.returnType = parent.getReturnType();
		else this.returnType = VarType.NONE;
	}
	...
	/**
	 * Indicates whether this scope should stop executing. Only used for functions
	 * or scopes that are descendants of functions.
	 * 
	 * @return true if this scope should stop executing, false otherwise.
	 */
	...
	/**
	 * Marks that this scope should stop executing, along with any parent scopes.
	 * Only used for functions or scopes that are descendants of functions.
	 */
