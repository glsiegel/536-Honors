...
public interface IEnvironment<T> {
	...
	/**
	 * Gets the object associated with the identifier. Scope-aware. Gets the most
	 * nested value for the identifier.
	 * 
	 ...
	 * 
	 * @return true iff this environment is a function
	 */
	public boolean isFunction();

	/**
	 * Gets the depth of the scope. Globals are at 0, the next level is 1, then 2,
	 * and so on. Higher depth means more nested scope. Function scopes are thus at
	 * 1.
	 * 
	 * @return depth of the environment
	 */
	public int getDepth();

	/**
	 * Gets the return type. Meaningless if not a function, since we're not in Rust.
	 * 
	 * @return return type of environment
	 */
	public VarType getReturnType();

	/**
	 * Gets the kindIdx of an identifier. Used for semantic analysis. This does mean
	 * that environments will need to deduce some method for storing which kind each
	 * identifier is.
	 * 
	 * @param name identifier
	 * @return index into the IdentifierInfo.KINDS array, for semantic coloring
	 */
