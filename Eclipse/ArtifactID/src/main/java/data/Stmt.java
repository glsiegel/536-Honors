...
public abstract class Stmt {
	...
	/**
	 * Statement that determines how THIS file relates to root. Sort of like how in
	 * Java, files have "package" at the top. It's the same syntax.
	 * 
	 * as edu.wisc.main;
	 * 
	 * This means that, in the root directory, THIS file can be found at
	 * root/edu/wisc/main.bl.
	 * 
	 * I tried REALLY hard to be able to do without these sorts of statements. After
	 * trying though, I have a newfound appreciation for why they exist. They
	 * simplify a lot of issues with trying to determine what "project" a file is
	 * in.
	 * 
	 * C uses a totally different structure that does not require this sort of
	 * thing, but C's structure when using multiple files sucks and I desperately
	 * wanted to avoid all that.
	 */
	public static class As extends Stmt {
		/**
		 * The rootpath of THIS file.
		 */
		public final Rootpath rootpath;
		/**
		 * Semantic analysis. Section around the rootpath portion.
