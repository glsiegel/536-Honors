...
public class CodeSection {
	 ...
	 * 
	 * @param first  token start
	 * @param second section end
	 */
	 ...
	 * 
	 * @param first  section start
	 * @param second token end
	 */
	...
	/**
	 * Converts from a CodeSection to a Range. LSP prefers ranges, but I do things
	 * using CodeSections, so this provides easy translation.
	 * 
	 * @return range version of section
	 */
